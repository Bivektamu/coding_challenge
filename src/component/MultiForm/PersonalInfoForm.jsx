...
const PersonalInfoForm = ({ formData, errors, onChangeHandler, onSubmitHandler }) => {
    ...
    return (
        <>
            ...
            <form id="personal_info_form" action="" onSubmit={e => onSubmitHandler(e)} className='text-left grid-cols-2 grid gap-x-10 gap-y-5   mb-8'>
                ...
                <div className="border-t-[1px] border-gray-200 pt-8 mt-4 col-span-2">
